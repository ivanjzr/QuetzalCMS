...
if not use_system_version:
    try:
        ...
        # There is a "easy_json" package around that is not Python's "easy_json", so we
...
if not use_system_version:
    ...
    from idx.utils.simplejson.decoder import JSONDecoder
    from idx.utils.simplejson.encoder import JSONEncoder
